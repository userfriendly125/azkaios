                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(
                          '${lang.S.of(context).seller}: ${widget.transitionModel.sellerName.isEmptyOrNull ? 'Admin' : widget.transitionModel.sellerName}',
                          style: kTextStyle.copyWith(color: kTitleColor),
                        ),
                      ],
                    ),
                      ...
                      child: DataTable(
                          ...
                          rows: List.generate(widget.transitionModel.productList!.length, (i) {
                            return DataRow(cells: [
                              ...
                              DataCell(
                                Text(
                                  '$currency ${myFormat.format(double.tryParse(widget.transitionModel.productList![i].subTotal) ?? 0)}',
                                  maxLines: 1,
                                  textAlign: TextAlign.center,
                                  overflow: TextOverflow.ellipsis,
                                  style: kTextStyle.copyWith(color: kGreyTextColor),
