                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: ListTile(
                                      ...
                                      subtitle: Text('${lang.S.of(context).totalSale} ${isPicked ? '${lang.S.of(context).from} ${fromDate.toString().substring(0, 10)} ${lang.S.of(context).to} ${toDate.toString().substring(0, 10)})' : lang.S.of(context).thisMonth}'),
                                    ),
                                  ),
                                ),
                              ),
