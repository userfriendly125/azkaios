...
import 'package:mobile_pos/Screens/Quotation/add_quotation.dart';
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              ...
                              AddQuotationScreen(customerModel: guestModel).launch(context);
                              cart.clearCart();
                            },
                            child: Padding(
                                ...
                                return (customer[index].phoneNumber.toLowerCase().contains(searchCustomer.toLowerCase()) || customer[index].customerName.toLowerCase().contains(searchCustomer.toLowerCase())) && !customer[index].type.contains('Supplier')
                                    ? Column(
                                        children: [
                                          GestureDetector(
                                            onTap: () {
                                              AddQuotationScreen(customerModel: customer[index]).launch(context);
                                              cart.clearCart();
                                            },
                                            child: Column(
                                              children: [
