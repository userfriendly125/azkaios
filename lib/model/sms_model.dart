class SmsModel {
  SmsModel({this.customerName, this.customerPhone, this.sellerId, this.sellerName, this.sellerMobile, this.invoiceNumber, this.totalAmount, this.dueAmount, this.paidAmount, this.type, this.status});
